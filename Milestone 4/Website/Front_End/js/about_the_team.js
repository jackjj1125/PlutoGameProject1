var teams = [{name:"Suyogya Poudel", img: "../img/suyogya.jpg", alt:"Image of Suyogya", year:"Freshman", major:"Computer Science", description:"-----"},
				...
				{name:"Jaylee Chase", img: "../img/jaylee.jpg", alt:"Image of Jaylee", year:"Sophomore", major:"Computer Science", description:"-----"},
				{name:"Veda Jammula", img: "../img/veda.jpeg", alt:"Image of Veda", year:"Sophmore", major:"Computer Science", description:"-----"},
				{name:"Sam Williamson", img: "../img/sam.jpeg", alt:"Image of Sam", year:"Junior", major:"Computer Science", description:"-----"},
				{name:"Jack Flaherty", img: "../img/jack.jpeg", alt:"Image of Jack", year:"Sophmore", major:"Computer Science", description:"-----"}];
